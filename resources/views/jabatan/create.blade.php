...
@section('page-subtitle', 'Tambahkan data master jabatan baru')
    ...
    <form action="{{ route('jabatan.store') }}" method="POST" class="p-6">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" id="nama" name="nama" value="{{ old('nama') }}" required class="w-full px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" placeholder="Contoh: Kupas Kelapa">
