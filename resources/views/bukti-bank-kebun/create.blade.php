@extends('layouts.app')
@section('title', 'Buat Bukti Bank Kebun Baru')
...
<div class="max-w-5xl mx-auto pb-10">
    <div class="mb-8">
        ...
        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Buat Bukti Bank Kebun</h2>
    </div>
    ...
    <form action="{{ route('bukti-bank-kebun.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden" id="form-pengajuan">
        @csrf
        ...
        <div class="p-6 md:p-8 border-b border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="no_bukti" placeholder="Contoh: BKK-2026-001"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="judul_pengajuan" placeholder="Contoh: Belanja Bulanan Basecamp" required
                           class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Ditransfer Ke (Opsional)</label>
                    <input type="text" name="ditransfer_ke" placeholder="Contoh: ANTONIUS STANLY RANSANG"
                           class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Bank / Rekening Tujuan (Opsional)</label>
                    <input type="text" name="bank_rek_tujuan" placeholder="Contoh: BRI 105401018819502"
                           class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all">
                </div>
                <div class="md:col-span-2">
                ...
                <table class="w-full text-left border-collapse min-w-[700px]">
                    ...
                    <tbody id="items-container" class="divide-y divide-gray-100 bg-white">
                        <tr class="item-row">
                            ...
                            <td class="py-3 px-4">
                                <input type="number" name="harga_satuan[]" required min="0" placeholder="0" class="w-full px-3 py-2 rounded border border-gray-200 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none text-sm input-harga">
                            </td>
