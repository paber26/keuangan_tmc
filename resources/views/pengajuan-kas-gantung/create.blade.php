@extends('layouts.app')
@section('title', 'Buat Pengajuan Kas Gantung (A5) Baru')
...
<div class="max-w-5xl mx-auto pb-10">
    <div class="mb-8">
        ...
        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Buat Pengajuan Kas Gantung (A5)</h2>
    </div>
    ...
    <form action="{{ route('pengajuan-kas-gantung.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden" id="form-pengajuan">
        @csrf
        ...
        <div class="p-6 md:p-8 border-b border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="pengajuan_kebutuhan" placeholder="Contoh: KEBUN A"
                           class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all">
                </div>
        ...
        <div class="p-6 border-t border-gray-100 bg-white flex justify-end">
            <button type="submit" class="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl shadow-sm transition-all focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
                Simpan Pengajuan Kas Gantung (A5)
            </button>
        </div>
    </form>
</div>
