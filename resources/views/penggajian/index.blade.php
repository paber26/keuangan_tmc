        ...
        <form method="GET" action="{{ route('penggajian.index') }}" class="px-6 py-4">
            <div class="flex flex-wrap items-end gap-4">
                ...
                <div>
                    ...
                    <button type="button" onclick="window.print()" class="ml-2 inline-flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg shadow-sm transition-colors">
