                ...
                <table class="w-full text-left border-collapse min-w-[600px]">
                    ...
                    <tbody id="items-container" class="divide-y divide-gray-100 bg-white">
                        ...
                        <tr class="item-row">
                            ...
                            <td class="py-3 px-4">
                                <input type="number" name="harga_per_liter[]" value="{{ $item->harga_per_liter ?? 16000 }}" required min="0" class="w-full px-3 py-2 rounded border border-gray-200 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none text-sm font-bold input-harga-liter">
                            </td>
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-1 bg-gray-50 px-3 py-2 rounded border border-gray-100">
                                    ...
                                    <input type="text" readonly class="w-full bg-transparent border-none p-0 focus:ring-0 text-emerald-700 outline-none text-sm font-bold input-total-harga-display" value="{{ number_format(round($item->total_harga), 0, ',', '.') }}">
