                ...
                <table class="w-full text-left border-collapse min-w-[600px]">
                    ...
                    <tbody id="items-container" class="divide-y divide-gray-100 bg-white">
                        ...
                        <tr class="item-row">
                            ...
                            <td class="py-3 px-4">
                                <input type="number" name="total_harga[]" value="{{ round($item->total_harga) }}" required readonly class="w-full px-3 py-2 rounded border border-gray-100 bg-gray-50 text-emerald-700 outline-none text-sm font-bold input-total-harga">
                            </td>
                            <td class="py-3 px-4">
