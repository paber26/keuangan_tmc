    ...
    <div class="wrapper">
        ...
        <table class="info-table">
            <tr>
                ...
                <td>: {{ strtoupper($pengajuan_bbm->departemen ?? 'PERKEBUNAN') }}</td>
            </tr>
            <tr>
                <td>Pengajuan Untuk Kebutuhan</td>
                <td>: {{ $pengajuan_bbm->kebun ? $pengajuan_bbm->kebun->lokasi : '-' }}</td>
            </tr>
            <tr>
                <td>Perihal</td>
                <td>: {{ $pengajuan_bbm->perihal ?? 'Kebutuhan Biaya BBM' }}</td>
            </tr>
            <tr>
        ...
        <table class="items-table" style="border-left: none; border-right: none; border-bottom: none;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="font-bold">{{ strtoupper($item->uraian) }}</td>
                    <td class="font-bold">
                ...
                <tr>
                    ...
                    <td class="font-bold">
                        <span class="rp">Rp</span>
                        <span class="nominal">{{ number_format($pengajuan_bbm->grand_total, 0, ',', '.') }}</span>
                        <div style="clear: both;"></div>
                    </td>
                    <td style="border-right: none;"></td>
                </tr>
