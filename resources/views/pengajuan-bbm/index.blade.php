                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('pengajuan-bbm.show', $item->id) }}#dokumentasi" class="p-1.5 text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors" title="Lihat Dokumentasi (Ada Foto)">
                                ...
                                @endif
                                <a href="{{ route('pengajuan-bbm.show', $item->id) }}" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded transition-colors" title="Lihat Detail">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                </a>
                                <a href="{{ route('pengajuan-bbm.edit', $item->id) }}" class="p-1.5 text-amber-600 hover:bg-amber-50 rounded transition-colors" title="Edit Data">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                </a>
                                <form action="{{ route('pengajuan-bbm.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirmMath(event);">
                                    @csrf
                                    @method('DELETE')
