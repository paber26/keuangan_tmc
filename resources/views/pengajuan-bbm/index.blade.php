                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('pengajuan-bbm.destroy', $item->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengajuan ini?');">
                                    @csrf
                                    @method('DELETE')
